...
# load data
df = pd.read_csv("https://raw.githubusercontent.com/louiee-jason/ecommerce-dashboard-analysis/main/dashboard/clean_data.csv")
...
st.markdown("""
- Revenue increased significantly and peaked at the end of 2017 before stabilizing in 2018.
Note: The drop at the end of the chart is caused by incomplete data.

- Sales are dominated by a few main product categories.  
- Credit card is the most commonly used payment method, followed by boleto.  
- Most customers only make a single transaction, indicating low customer retention.  
""")
